...
// Similar to RotationBetweenVectors, but also controls the vertical
// orientation. This assumes that at rest, the object faces +Z. Beware, the
// first parameter is a direction, not the target point !
