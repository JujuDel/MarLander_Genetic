...
// Uncomment below to launch OpenGL's Hello World
//#define DO_CUBE
int cube();
...
#  ifdef VISUALIZE_GENETIC
    ...
    GLuint programIDFloor = LoadShaders("../shaders/FloorVertexShader.vertexshader", "../shaders/FloorFragmentShader.fragmentshader");
    GLuint programIDLine = LoadShaders("../shaders/RocketFireVertexShader.vertexshader", "../shaders/RocketFireFragmentShader.fragmentshader");
    GLuint programIDRocket = LoadShaders("../shaders/RocketVertexShader.vertexshader", "../shaders/RocketFragmentShader.fragmentshader");
